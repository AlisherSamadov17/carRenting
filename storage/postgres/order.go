...
func (o *orderRepo) Create(or models.CreateOrder) (string,error) {
	...
	_,err:=o.db.Exec(context.Background(),query,id.String(),or.CarId,or.CustomerId,or.FromDate,or.ToDate,or.Status,or.Paid,or.Amount)
	if err != nil {
		return "",err
	}
...
func (o *orderRepo) Update(or models.UpdateOrder) (string,error) {
	query:=`update orders set
	   ...
	   WHERE id=$6
	`
	_,err:=o.db.Exec(context.Background(),query,or.FromDate,or.ToDate,or.Status,or.Paid,or.Amount,or.Id)
	if err != nil {
		return "",err
	}
	return or.Id,nil
